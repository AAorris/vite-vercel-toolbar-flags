// https://github.com/brillout/vite-to-vike/commit/97842c99b4b2b0816d85589f2297aec52560bae8#diff-bcb729747c92e72c12e4590f736a334041a572c429756da8af60b6ab89c6be79R78
...
import { verifyAccess, decrypt } from "@vercel/flags";
import flagDefinitions from "./flags.js";
...
async function startServer() {
  ...
  app.get("*", async (req, res, next) => {
    // Toolbar flags: List the available flags
    // TODO: verifyAccess
    if (req.originalUrl.startsWith("/.well-known/vercel/flags")) {
    ...
    const vercelFlagOverrideCookie = req.headers["cookie"]
      ? req.headers["cookie"]
          .split("; ")
          .find((c) => c.startsWith("vercel-flag-overrides="))
      : null;
